...
RUN apt-get update && \
	...
	apt-get update && \
	apt-get upgrade -y && \
	BUILD_PACKAGES="wget vim supervisor nginx php7.2-fpm git php7.2-mysql php7.2-curl php7.2-gd php7.2-intl php7.2-sqlite php7.2-tidy php7.2-xmlrpc php7.2-xsl php7.2-pgsql php7.2-ldap pwgen unzip php7.2-zip curl php7.2-mbstring php-mongodb cron php-mcrypt php7.2-xdebug" && \
